...
export class Hexagon extends Shape {
  ...
  protected override createShape(): void {
    this._points = [
      new Point(
        random(ShapeSize.WIDTH_MAX / 4, ShapeSize.WIDTH_MAX / 2),
        random(0, ShapeSize.HEIGHT_MAX / 3)
      ),
      new Point(
        random(ShapeSize.WIDTH_MAX / 2, (ShapeSize.WIDTH_MAX * 3) / 4),
        random(0, ShapeSize.HEIGHT_MAX / 3)
      ),
      new Point(
        random((ShapeSize.WIDTH_MAX * 3) / 4, ShapeSize.WIDTH_MAX),
